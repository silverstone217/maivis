        ...
        >
          <AuthProvider>
            <div className="h-screen w-screen overflow-hidden relative">
              <div className="z-10 overflow-x-hidden w-full gap-10 flex flex-col items-center justify-between scrollbar-hide overflow-y-auto h-[calc(100dvh)] scroll-smooth scroll-div">
                {/* <PaddingTopComponent /> */}
